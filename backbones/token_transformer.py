...
class Token_transformer(nn.Module):
    def __init__(self, num_patch, dim, in_dim, num_heads, mlp_ratio=1., qkv_bias=False, qk_scale=None, drop=0.,
                 attn_drop=0.,
                 drop_path=0., act_layer=nn.GELU, norm_layer=None):
        super().__init__()

        self.bn1 = nn.BatchNorm1d(num_patch)
        self.bn2 = nn.BatchNorm1d(num_patch)

        self.attn = Attention(dim, in_dim=in_dim, num_heads=num_heads,
